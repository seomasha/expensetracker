...
function ExpenseForm({onCancel, onSubmit, submitButtonLabel, defaultValues}) {
        ...
        if(!amountIsValid || !dateIsValid || !descriptionIsValid) {
            ...
            setInputs((curInputs) => {
                return {
                    ...
                    description: {value: curInputs.description.value, descriptionIsValid: amountIsValid}
                }
            })
            return;
        }
    ...
    return(
        <View style={styles.form}>
            ...
            <Input invalid={!inputs.description.isValid} label="Destcription" textInputConfig={{
                multiline: true,
                // autocorrect: true, default
                // autoCapitalized: "sentences" default
